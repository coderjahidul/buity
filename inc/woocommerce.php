...
/**
 * Filter My Account orders by status query parameter.
 *
 * @param array $args Query arguments.
 * @return array
 */
function buity_filter_my_orders_by_status($args)
{
...
add_filter('woocommerce_my_account_my_orders_query', 'buity_filter_my_orders_by_status');

/**
 * Remove the "Downloads" tab from My Account.
 *
 * @param array $items Menu items.
 * @return array
 */
function buity_remove_downloads_tab($items)
{
...
add_filter('woocommerce_account_menu_items', 'buity_remove_downloads_tab');
